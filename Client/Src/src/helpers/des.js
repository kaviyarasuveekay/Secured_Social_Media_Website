...
// const generate_keys_128 = (key, rounds) => {
//   // PC1 table
//   const pc1 = [
//     42, 36, 63, 5, 98, 109, 87, 47, 83, 17, 74, 114, 60, 106, 108, 52, 39, 92,
//     61, 13, 26, 37, 95, 14, 29, 7, 19, 78, 73, 68, 12, 4, 91, 126, 10, 57, 38,
//     94, 85, 76, 125, 23, 118, 70, 20, 11, 51, 33, 27, 81, 111, 65, 121, 55, 119,
//     31, 93, 46, 21, 115, 69, 103, 49, 34, 35, 18, 30, 75, 3, 58, 45, 1, 127, 86,
//     107, 77, 84, 15, 82, 113, 105, 117, 90, 54, 43, 102, 44, 2, 124, 6, 22, 25,
//     101, 79, 50, 71, 116, 123, 9, 122, 89, 41, 97, 62, 67, 66, 28, 99, 53, 100,
//     110, 59,
//   ];
//   // PC2 table
//   const pc2 = [
//     42, 100, 63, 69, 18, 45, 55, 15, 83, 49, 106, 34, 98, 28, 44, 84, 71, 12,
//     61, 95, 62, 13, 7, 111, 3, 78, 89, 20, 92, 39, 68, 75, 94, 90, 73, 22, 30,
//     37, 93, 54, 102, 110, 107, 109, 51, 65, 91, 81, 1, 25, 99, 10, 67, 77, 5,
//     19, 53, 97, 101, 33, 50, 35, 103, 82, 74, 6, 58, 23, 31, 79, 26, 2, 66, 59,
//     47, 21, 9, 70, 87, 86, 105, 85, 60, 57, 11, 41, 43, 29, 36, 17, 46, 14, 27,
//     38, 52, 76,
//   ];
//   let round_keys = [];
...
//     42, 36, 63, 5, 98, 109, 87, 47, 83, 17, 74, 114, 60, 106, 108, 52, 39, 92,
//     61, 8, 13, 26, 37, 95, 14, 29, 7, 56, 72, 19, 78, 73, 68, 12, 32, 4, 91,
//     126, 10, 57, 38, 94, 85, 76, 125, 23, 118, 70, 20, 11, 51, 33, 27, 81, 111,
//     65, 121, 55, 119, 31, 93, 46, 80, 21, 115, 69, 103, 49, 34, 35, 18, 30, 75,
//     3, 58, 45, 1, 127, 86, 107, 77, 84, 64, 104, 15, 112, 88, 128, 16, 82, 113,
//     120, 105, 117, 90, 54, 43, 102, 44, 2, 96, 124, 6, 22, 25, 101, 79, 50, 71,
//     116, 48, 123, 9, 122, 89, 41, 97, 62, 24, 40, 67, 66, 28, 99, 53, 100, 110,
//     59,
//   ];
//   // The expansion table
//   const expansion_table = [
//     64, 1, 2, 3, 4, 5, 4, 5, 6, 7, 8, 9, 8, 9, 10, 11, 12, 13, 12, 13, 14, 15,
//     16, 17, 16, 17, 18, 19, 20, 21, 20, 21, 22, 23, 24, 25, 24, 25, 26, 27, 28,
//     29, 28, 29, 30, 31, 32, 33, 32, 33, 34, 35, 36, 37, 36, 37, 38, 39, 40, 41,
//     40, 41, 42, 43, 44, 45, 44, 45, 46, 47, 48, 49, 48, 49, 50, 51, 52, 53, 52,
//     53, 54, 55, 56, 57, 56, 57, 58, 59, 60, 61, 60, 61, 62, 63, 64, 1,
//   ];
...
//     42, 36, 63, 5, 34, 45, 23, 47, 19, 17, 10, 50, 60, 44, 52, 39, 28, 61, 8,
//     13, 26, 37, 31, 14, 29, 7, 56, 9, 4, 12, 32, 27, 62, 57, 38, 30, 21, 54, 6,
//     20, 11, 51, 33, 1, 55, 46, 16, 49, 35, 18, 3, 58, 22, 43, 64, 40, 15, 48,
//     24, 41, 53, 2, 25, 59,
//   ];
//   // The inverse permutation table
//   const inverse_permutation = [
//     77, 100, 74, 36, 4, 103, 27, 20, 113, 39, 50, 34, 21, 25, 85, 89, 10, 71,
//     30, 49, 64, 104, 46, 119, 105, 22, 53, 123, 26, 72, 60, 35, 52, 69, 70, 2,
//     23, 41, 17, 120, 116, 1, 97, 99, 76, 62, 8, 111, 68, 108, 51, 16, 125, 96,
//     58, 28, 40, 75, 128, 13, 19, 118, 3, 83, 56, 122, 121, 33, 66, 48, 109, 29,
//     32, 11, 73, 44, 81, 31, 107, 63, 54, 90, 9, 82, 43, 79, 7, 87, 115, 95, 37,
//     18, 61, 42, 24, 101, 117, 5, 124, 126, 106, 98, 67, 84, 93, 14, 80, 15, 6,
//     127, 55, 86, 91, 12, 65, 110, 94, 47, 59, 92, 57, 114, 112, 102, 45, 38, 78,
//     88,
//   ];
...
// const des = (key, pt, rounds, encrypt) => {
